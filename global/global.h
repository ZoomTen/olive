...
public slots:
    ...
    /**
     * @brief set the export format for batch export
     */
    void set_export_format(QString format);

    /**
     * @brief get the export format for batch export
     */
    long int get_export_format();
